        ...
        <div className="product">
            <div className="product__images">
                <div className="product__images__list">
                    ...
                    <div className="product__images__list__item" onClick={() => setPreviewImg(product.image05)}>
                        <img src={product.image05} alt="" />
                    </div>
                    <div className="product__images__list__item" onClick={() => setPreviewImg(product.image06)}>
            ...
            <div className="product__info">
                ...
                <div className="product__info__item">
                    <Button onClick={() => addToCart()}>đặt ngay</Button>
